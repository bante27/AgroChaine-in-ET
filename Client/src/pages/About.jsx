        ...
        <div className="max-w-7xl mx-auto px-10 sm:px-12 lg:px-16">
          ...
          <div className="space-y-20">
            {services.map((service, index) => (
              ...
              >
                <div className={index % 2 === 1 ? 'lg:col-start-2 order-2 lg:order-1' : 'order-1'} style={{ clipPath: 'polygon(5% 0%, 95% 0%, 100% 95%, 0% 95%)', minHeight: '350px' }} /* Increased minHeight */
                >
                  ...
                  <p className="text-xl sm:text-2xl text-gray-700 mb-8 leading-relaxed" style={{ minHeight: '150px' }} /* Increased minHeight */
                  ...
                  <div className="space-y-5 mb-8">
                    {service.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center space-x-4">
                        ...
                        <span className="text-lg sm:text-xl text-gray-700">{feature}</span>
                      </div>
                    ))}
                  </div>
                </div>
