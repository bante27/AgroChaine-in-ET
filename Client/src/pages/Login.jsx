...
const OTPInput = ({ email, otp, onVerify, onResend }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-6 px-4 bg-white">
      <Card className="bg-white/80 backdrop-blur-md border border-gray-100 shadow-xl rounded-xl p-6 max-w-sm w-full">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800">Verify Your Email</h2>
          <p className="text-gray-600 text-sm mt-1">Enter OTP sent to {email}</p>
        </div>
        <form className="space-y-4 mt-4">
          <Input
            ...
            className="text-base py-2 bg-gray-50 border-gray-200 text-gray-800 placeholder-gray-400"
          />
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 rounded-lg"
          >
            Verify
...
const Login = () => {
  ...
  const renderBasicInfo = () => (
    <div className="space-y-4">
      <div className="text-center mb-4">
        <h3 className="text-lg font-bold text-gray-800">Basic Info</h3>
      </div>
      ...
      {passwordStrength && (
        <p className={`text-xs ${passwordStrength === 'Strong' ? 'text-indigo-600' : 'text-red-600'}`}>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-6 px-4 bg-white">
      <div className="flex items-center justify-between w-full max-w-6xl h-[80vh]">
          ...
          <div className="text-center mb-6">
            <Link to="/" className="flex items-center justify-center space-x-2">
              <div className="relative">
                ...
                <span className="absolute -top-1 -right-1 bg-amber-500 text-white text-xs font-bold rounded-full w-4 h-4 flex items-center justify-center border-2 border-gray-800">
                  ET
                </span>
              </div>
              <div className="flex flex-col -space-y-1">
                <span className="text-2xl font-bold text-gray-800">AgroChain</span>
                <span className="text-sm font-semibold text-indigo-600">Ethiopia</span>
              </div>
            </Link>
            <h2 className="text-2xl font-bold text-gray-800 mt-4">{isLogin ? 'Welcome Back' : 'Join Us'}</h2>
            <p className="text-gray-600 text-sm">{isLogin ? 'Sign in' : 'Create account'}</p>
          </div>
          <Card className="bg-white/90 backdrop-blur-md border border-gray-100 shadow-xl rounded-xl p-6">
            ...
            <div className="mt-4 text-center">
              ...
              <Button
                ...
                className="w-full mt-2 border-gray-200 text-gray-800 hover:bg-indigo-600 hover:text-white transition-all duration-200 rounded-lg"
              >
              ...
              {isAuthenticated && (
                <Button
                  ...
                  className="w-full mt-2 border-red-400 text-red-600 hover:bg-red-600 hover:text-white transition-all duration-200 rounded-lg"
                >
                  Logout
                </Button>
              )}
        ...
        <motion.div
          ...
          className="w-full md:w-1/2 h-full bg-white flex items-center justify-center relative overflow-hidden"
        >
          ...
          >
            <h1 className="text-4xl font-extrabold text-indigo-600 drop-shadow-lg">AgroChain</h1>
            <p className="text-xl text-purple-600 mt-2 drop-shadow">Empowering Ethiopian Agriculture</p>
            <p className="text-sm text-gray-600 mt-1">Join us today at 12:05 PM EAT, August 29, 2025!</p>
          </motion.div>
        </motion.div>
      </div>
      <LiveChat />
