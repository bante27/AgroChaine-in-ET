  ...
  // Validation functions
      ...
      const handleSaveCredentials = (save) => {
        if (save) {
          ...
          toast.success('Credentials saved to password manager');
        } else {
            ...
            return;
                  ...
                  try {
                    ...
                    if (result.success) {
                      ...
                      // Show the save prompt only if "Remember me" is not checked
                      if (!rememberMe) {
                  ...
                  try {
                    ...
                    if (response.data.success) {
                      ...
                      // Show save prompt after registration
                      setShowSavePrompt(true);
                    } else {
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Input
                      ...
                      className="text-lg py-3 text-[#9b045c23]"
                    />
                    <PhoneNumberInput
                      label="Phone Number *"
                      name="phone"
                      ...
                      className="text-lg py-3 text-[hsl(244,63%,39%)]"
                    />
                    <div className="md:col-span-1">
                      <Input
                        ...
                        className="text-lg py-3 text-[rgb(79,54,223)]"
                    ...
                    <div className="md:col-span-1">
                      <Input
                        ...
                        className="text-lg py-3 text-[hsl(236,62%,49%)]"
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="relative">
                      <Input
                        ...
                        required
                        className="text-lg py-3 text-[#4c335c]"
                ...
                <>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      required
                      placeholder="Enter your password"
                      className="text-lg py-3 bg-white/5 border-white text-white placeholder-gray-400"
