    ...
    marketplace: {
      ...
      filters: {
        ...
        product: {
          ...
          anonymous: 'Anonymous',
          errors: {
            loginToReview: 'Login required to post a review.',
            postFailed: 'Failed to post review.',
            loginToLike: 'Login required to like.',
    ...
    am: {
      ...
      marketplace: {
        ...
        filters: {
          ...
          adjustSearch: 'እባክዎን ፍለጋዎን ወይም ማጣሪያዎን ለማስተካከል ይሞክሩ።',
          ...
          product: {
            ...
            anonymous: 'ስም ያልታወቀ',
            errors: {
              loginToReview: 'ግምገማ ለመለጠፍ መግባት ያስፈልጋል።',
              postFailed: 'ግምገማ መለጠፍ አልተቻለም።',
              loginToLike: 'ላይክ ለማድረግ መግባት ያስፈልጋል።',
              likeFailed: 'ላይክ ማዘመን አልተቻለም።'
            }
          },
          productsFound: 'ምርቶች ተገኝተዋል',
