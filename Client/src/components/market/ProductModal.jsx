...
import { X, Star, ShoppingCart } from 'lucide-react'; // Added ShoppingCart
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white rounded-xl text-black/55 max-w-2xl w-full max-h-[80vh] overflow-y-auto p-6 relative"
